...
import { ArrowRight, Lock, UserCog, ShieldCheck } from "lucide-react";
...
function TechnicianLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (techId === "tech" && password === "tech") {
      login(techId, "technician", "سالم العتيبي");
        ...
        <Card className="border-border shadow-elegant">
          ...
          <form onSubmit={handleLogin}>
            ...
            <CardFooter className="flex flex-col gap-4">
              <Button type="submit" className="w-full h-11 text-base font-bold bg-primary hover:bg-primary-deep rounded-xl">
                دخول للميدان
