...
export const Route = createFileRoute("/contractor/history")({
  ...
  component: () => (
    <PortalLayout title="إنجازات سابقة" items={sidebarItems}>
      <div className="p-8 text-center border-2 border-dashed border-border rounded-3xl bg-white">
        <CheckSquare className="h-16 w-16 mx-auto text-primary/20 mb-4" />
        <h2 className="text-2xl font-bold text-primary-deep">تاريخ الإنجازات</h2>
        <p className="text-muted-foreground mt-2">هذه الصفحة قيد التطوير حالياً لعرض أرشيف الأعمال التي تم تنفيذها بنجاح.</p>
      </div>
    </PortalLayout>
  ),
});
