  ...
  component: () => (
    <PortalLayout title="التقارير والتحليلات" items={sidebarItems}>
      <div className="p-8 text-center border-2 border-dashed border-border rounded-3xl bg-white">
        ...
        <h2 className="text-2xl font-bold text-primary-deep">التقارير</h2>
        <p className="text-muted-foreground mt-2">هذه الصفحة قيد التطوير حالياً لعرض مؤشرات الأداء والتقارير المالية.</p>
      </div>
    </PortalLayout>
  ),
});
