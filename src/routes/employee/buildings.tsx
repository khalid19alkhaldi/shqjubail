  ...
  component: () => (
    <PortalLayout title="إدارة المباني والأصول" items={sidebarItems}>
      <div className="p-8 text-center border-2 border-dashed border-border rounded-3xl bg-white">
        <Building2 className="h-16 w-16 mx-auto text-primary/20 mb-4" />
        <h2 className="text-2xl font-bold text-primary-deep">إدارة المباني</h2>
        <p className="text-muted-foreground mt-2">هذه الصفحة قيد التطوير حالياً لعرض سجلات المباني والأصول التابعة للجمعية.</p>
      </div>
    </PortalLayout>
  ),
});
